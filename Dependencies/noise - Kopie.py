...
class OUNoise(NoiseInterface):
    def __init__(self):
        ...
        self.reset_count = 0  # Track resets for decay adjustments
    ...
    def sample(self):
        """Apply Ornstein-Uhlenbeck process for correlated noise."""
        x = self.state
